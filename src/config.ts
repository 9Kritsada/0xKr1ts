...
export const siteConfig: SiteConfig = {
  ...
  favicon: [    // Leave this array empty to use the default favicon
    {
      src: '/favicon/GOAT2.png',    // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
  avatar: 'assets/images/GOAT2.webp',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
